...
{
    public partial class materia1 : System.Web.UI.Page
    {
        int id_rol = 0;
        ...
        void CargarTabla()
        {
            SqlCommand cmd = new SqlCommand("sp_loadM1", con);
            cmd.CommandType = CommandType.StoredProcedure;
            con.Open();
        ...
        {
            Response.Redirect("~/Pages/CRUD1.aspx?op=C");
        }
        ...
        protected void btnread_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Pages/CRUD1.aspx?id="+id+"&op=R");
        }
        ...
        protected void btnupdate_Click(object sender, EventArgs e)
        {
            ...
            GridViewRow selectedrow = (GridViewRow)BtnConsultar.NamingContainer;
            id = selectedrow.Cells[1].Text;
            Response.Redirect("~/Pages/CRUD1.aspx?id=" + id + "&op=U");
        }
        ...
        protected void btndelete_Click(object sender, EventArgs e)
        {
            ...
            GridViewRow selectedrow = (GridViewRow)BtnConsultar.NamingContainer;
            id = selectedrow.Cells[1].Text;
            Response.Redirect("~/Pages/CRUD1.aspx?id=" + id + "&op=D");
        }
