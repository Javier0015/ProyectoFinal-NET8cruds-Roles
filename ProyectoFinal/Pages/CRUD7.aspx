<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MP.Master" AutoEventWireup="true" CodeBehind="CRUD7.aspx.cs" Inherits="ProyectoFinal.Pages.CRUD7" %>
...
<div class="mb-3">
 ...
 <div class="mb-3">
    ...
    <asp:TextBox runat="server" CssClass="form-control" ID="tbcfinal">
            ...
            <asp:Button runat="server" CssClass="button is-darky" ID="btncreate" Text="Crear" Visible="false" OnClick="btncreate_Click" />
