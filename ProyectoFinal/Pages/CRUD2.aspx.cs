...
namespace ProyectoFinal.Pages
{
    public partial class CRUD2 : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("sp_createM2", con);
            con.Open();
            ...
            cmd.ExecuteNonQuery();
            con.Close();
            Response.Redirect("materia2.aspx");
        }

        protected void btnupdate_Click(object sender, EventArgs e)
        {
            SqlCommand cmd = new SqlCommand("sp_updateM2", con);
            con.Open();
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand cmd = new SqlCommand("sp_deleteM2", con);
            con.Open();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("@IdM1", SqlDbType.Int).Value = sID;
            cmd.ExecuteNonQuery();
        ...
        {
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("sp_readM2", con);
