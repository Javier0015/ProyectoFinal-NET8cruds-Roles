...
{
    public partial class CRUD5 : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("sp_createM5", con);
            con.Open();
            ...
            cmd.ExecuteNonQuery();
            con.Close();
            Response.Redirect("materia5.aspx");
        }

        protected void btnupdate_Click(object sender, EventArgs e)
        {
            SqlCommand cmd = new SqlCommand("sp_updateM5", con);
            con.Open();
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand cmd = new SqlCommand("sp_deleteM5", con);
            con.Open();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("@IdM1", SqlDbType.Int).Value = sID;
            cmd.ExecuteNonQuery();
        ...
        {
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("sp_readM5", con);
