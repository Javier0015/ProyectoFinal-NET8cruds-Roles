...
{
    public partial class CRUD6 : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("sp_createM6", con);
            con.Open();
            ...
            cmd.ExecuteNonQuery();
            con.Close();
            Response.Redirect("materia6.aspx");
        }

        protected void btnupdate_Click(object sender, EventArgs e)
        {
            SqlCommand cmd = new SqlCommand("sp_updateM6", con);
            con.Open();
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand cmd = new SqlCommand("sp_deleteM6", con);
            con.Open();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("@IdM1", SqlDbType.Int).Value = sID;
            cmd.ExecuteNonQuery();
        ...
        {
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("sp_readM6", con);
