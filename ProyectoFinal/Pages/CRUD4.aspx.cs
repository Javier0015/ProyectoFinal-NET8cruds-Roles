...
{
    public partial class CRUD4 : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("sp_createM4", con);
            con.Open();
            ...
            cmd.ExecuteNonQuery();
            con.Close();
            Response.Redirect("materia4.aspx");
        }

        protected void btnupdate_Click(object sender, EventArgs e)
        {
            SqlCommand cmd = new SqlCommand("sp_updateM4", con);
            con.Open();
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand cmd = new SqlCommand("sp_deleteM4", con);
            con.Open();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("@IdM1", SqlDbType.Int).Value = sID;
            cmd.ExecuteNonQuery();
        ...
        {
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("sp_readM4", con);
