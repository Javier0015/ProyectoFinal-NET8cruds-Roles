...
{
    public partial class materia3 : System.Web.UI.Page
    {
        int id_rol = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            void CargarTabla()
            {
                SqlCommand cmd = new SqlCommand("sp_loadM3", con);
        ...
        {
            Response.Redirect("~/Pages/CRUD3.aspx?op=C");
        }
        ...
        protected void btnread_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Pages/CRUD3.aspx?id=" + id + "&op=R");
        }
        ...
        protected void btnupdate_Click(object sender, EventArgs e)
        {
            ...
            GridViewRow selectedrow = (GridViewRow)BtnConsultar.NamingContainer;
            id = selectedrow.Cells[1].Text;
            Response.Redirect("~/Pages/CRUD3.aspx?id=" + id + "&op=U");
        }
        ...
        protected void btndelete_Click(object sender, EventArgs e)
        {
            ...
            GridViewRow selectedrow = (GridViewRow)BtnConsultar.NamingContainer;
            id = selectedrow.Cells[1].Text;
            Response.Redirect("~/Pages/CRUD3.aspx?id=" + id + "&op=D");
        }
    }
}