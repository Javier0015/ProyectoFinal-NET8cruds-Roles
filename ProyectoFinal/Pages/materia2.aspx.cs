...
{
    public partial class materia2 : System.Web.UI.Page
    {
        int id_rol = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            void CargarTabla()
            {
                SqlCommand cmd = new SqlCommand("sp_loadM2", con);
        ...
        protected void btnread_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Pages/CRUD2.aspx?id=" + id + "&op=R");
        }
        ...
        protected void btnupdate_Click(object sender, EventArgs e)
        {
            ...
            GridViewRow selectedrow = (GridViewRow)BtnConsultar.NamingContainer;
            id = selectedrow.Cells[1].Text;
            Response.Redirect("~/Pages/CRUD2.aspx?id=" + id + "&op=U");
        }
        ...
        protected void btndelete_Click(object sender, EventArgs e)
        {
            ...
            GridViewRow selectedrow = (GridViewRow)BtnConsultar.NamingContainer;
            id = selectedrow.Cells[1].Text;
            Response.Redirect("~/Pages/CRUD2.aspx?id=" + id + "&op=D");
        }

        protected void btncreate_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Pages/CRUD2.aspx?op=C");
        }
    }
}